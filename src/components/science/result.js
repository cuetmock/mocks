...
const SResult = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost/my-app/src/api/result.php', { withCredentials: true });
    ...
    return (
        ...
        <ul className="flex space-x-4 justify-around">
          ...
          <li><a href="/result" className="text-white font-bold navbar-item py-2 px-4 rounded-lg">My Results</a></li>
